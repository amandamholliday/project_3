...
const Home = () => (
  <div>
    <h1>Feeling stuck?</h1>
    <h2>This is an app designed to help you when you are just a little uninspired.</h2>
    ...
    <p>Do you work better under pressure? Skip right to the chase and set a <Link to="/timer">timer</Link> to get yourself into a productive groove.</p>
  </div>
);
